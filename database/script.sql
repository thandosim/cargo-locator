...
INSERT INTO trucks (truck_name, truck_capacity, truck_location, truck_latitude, truck_longitude, truck_availability, truck_driver_id) VALUES
('Mercedes Actros', 30000, 'Johannesburg, South Africa', -26.2041, 28.0473, FALSE, 1),
('Volvo FH', 26000, 'Gaborone, Botswana', -24.6282, 25.9231, FALSE, 2),
('Scania R500', 28000, 'Harare, Zimbabwe', -17.8292, 31.0522, FALSE, 3),
('MAN TGX', 25000, 'Maputo, Mozambique', -25.9663, 32.5700, FALSE, 4),
('DAF XF', 27000, 'Lusaka, Zambia', -15.3875, 28.3228, TRUE, 5),
('Isuzu Giga', 29000, 'Lilongwe, Malawi', -13.9833, 33.7833, FALSE, 6),
('Hino 700', 24000, 'Windhoek, Namibia', -22.5597, 17.0836, TRUE, 7),
('Freightliner Cascadia', 31000, 'Mbabane, Eswatini', -26.3054, 31.1367, TRUE, 8),
('Iveco Stralis', 26500, 'Kinshasa, DRC', -4.4419, 15.2663, FALSE, 9),
('Kenworth T680', 28500, 'Luanda, Angola', -8.8383, 13.2344, TRUE, 10),
('Peterbilt 579', 29500, 'Dodoma, Tanzania', -6.1722, 35.7395, FALSE, 11),
('Mack Anthem', 25000, 'Maseru, Lesotho', -29.3167, 27.4833, FALSE, 12),
('Renault Magnum', 27500, 'Blantyre, Malawi', -15.7861, 35.0058, TRUE, 13),
('Western Star 4900', 32000, 'Pretoria, South Africa', -25.7464, 28.1881, TRUE, 14),
('Hyundai Xcient', 27000, 'Francistown, Botswana', -21.1596, 27.5032, FALSE, 15),
('UD Quon', 26000, 'Bulawayo, Zimbabwe', -20.1539, 28.6178, FALSE, 16),
('Ford Cargo', 25500, 'Beira, Mozambique', -19.8233, 34.8383, TRUE, 17),
('Volvo VNL', 28000, 'Kitwe, Zambia', -12.8031, 28.2132, FALSE, 18),
('Scania S730', 27500, 'Tete, Mozambique', -16.1564, 33.5867, FALSE, 19),
('MAN TGS', 26500, 'Lubumbashi, DRC', -11.6696, 27.4793, TRUE, 20),
('Iveco Eurocargo', 24500, 'Dodoma, Tanzania', -6.1722, 35.7395, TRUE, 21),
('Mercedes-Benz Arocs', 31000, 'Mbabane, Eswatini', -26.3054, 31.1367, FALSE, 22),
('Volvo FMX', 28500, 'Kinshasa, DRC', -4.4419, 15.2663, FALSE, 23),
('Hino Profia', 27000, 'Johannesburg, South Africa', -26.2041, 28.0473, TRUE, 24),
('DAF CF', 26000, 'Lusaka, Zambia', -15.3875, 28.3228, TRUE, 25);
